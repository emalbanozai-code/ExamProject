...
export default function SettingsOverview() {
  ...
  const settingsCategories = [
    { title: t("mis.settings.general", "General Settings"), icon: "pi pi-cog", path: "/settings/general", description: t("mis.settings.generalDesc", "School information and basic configuration") },
